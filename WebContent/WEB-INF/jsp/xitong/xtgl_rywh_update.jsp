...
function userTel2(){
		var userTel2 = $("[name='userName']").val();	    
   		if(userTel2 != null && userTel2 !=""){		 
		}else{
...
function userTel3(){
	var userTel3 = $("[name='userPwd']").val();	    
	 
	if(userTel3 != null && userTel3 !=""){
...
function userTel4(){
	var userTel4 = $("[name='userSex']").val();	    
	 
	if(userTel4 != null && userTel4 !=""){			 
			}else{
				alert("性别不能为空");			 
		...
		<div class="sider_panel">
			...
			<div class="main_panel">
				<div class="content">
					...
					<form action="userController/updatePro" method="post" name="updateProForm">
				<div class="tableBox">
					<table class="table_ht">
						<tbody>
						<tr>							 
							<td width="10%">&nbsp;员工编号：</td>
							<td width="23%">${user.userCode }
							...
							<td width="23%">
								<input type="text" value="${user.userName }" name="userName" onkeyup="userTel2()">
							</td>
							<td colspan="2"></td>
						</tr>
						...
						<tr>
							...
							<td width="23%">
								<input type="text" value="${user.userPwd }" name="userPwd" onkeyup="userTel3()">
							</td>
							...
							<td width="23%">
								<input type="text" value="${user.userTel }" name="userTel" onkeyup="userTel1()"/>
						...
						<tr>
							...
							<td width="23%">
								<input type="text" value="${user.userCountry }" name="userCountry">
							</td>							  
						</tr>
						...
						<tr>
							...
							<c:if test="${user.userSex == '女' }">
								...
								<input type="radio" name="userSex" checked value="女"/> 女 
							</c:if>								 	
							</td>														 
						</tr>						 
						</tbody>
						...
						<form action="${pageContext.request.contextPath}/file/upload"
							...
							<div class="tableBox">
								...
								<input type="hidden" value="系统管理_人员维护" name="fileType"> <input
									type="hidden" value="${user.id }" name="objId"> 
							</div>
						</form>
						<div class="topTitle">
							<span><b></b>文件列表</span>
