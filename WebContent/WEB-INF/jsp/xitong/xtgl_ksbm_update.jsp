	...
	<div class="main">
		...
		<div class="main_panel">
			<div class="content">
				...
				<div class="tableBox">
					<form action="fastController/updatePro" method="post" name="queryFastForm"  id="queryFastForm">
						<div class="tableBox">
								...
								<tbody>
									<tr>	 
										 <td width="10%">&nbsp;id：</td>
											...
											<td width="23%">${fast.id}	
											 <input type="hidden" value="${fast.id }" name="id">
										 </td>
									</tr>
									<tr>
									...
									<tr>
										<td width="10%"><span class="notice">*</span>类型</td>
										 <td width="23%">
											<input type="text" name="fastType" id="fastType"  id="fastType"
											value="${fast.fastType}">												
									...
									<tr>
										<td width="10%"><span class="notice">*</span>类型中文名</td>
										 <td width="23%">
											...
											name="fastTypeName">
											<input type="hidden"  value="超级管理员" name="createUser" 
												value="${fast.createUser}">
										 </td>
										<td colspan="2"></td>
									</tr>
									 
									<tr>
										<td width="10%"><span class="notice">*</span>状态</td>
										<td width="23%">
										    <c:choose>
											...
											<tr>
										 <td  width="10%"><span class="notice">*</span>操作</td>
										 <td>
										 	 <c:choose>
												<c:when test="${fast.isFlag == 0}"><a href="fastController/delteFasts?id=${fast.id}">禁用</a></c:when>
												<c:otherwise>
													<c:if test="${fast.isFlag == 1 }"><a href="fastController/delteFast?id=${fast.id}">启用</a> </c:if>
												</c:otherwise>
											</c:choose>
						...
						<div class="submitCont">
							...
							<input class="submitBtn btn fr mr5" type="button" value="提交" onclick="upperCase()"/>
						</div>
					</form>
				</div>
			</div>
